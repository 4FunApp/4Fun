...
public class HeaderScrollingBehavior extends CoordinatorLayout.Behavior<RecyclerView> {
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, RecyclerView child, View dependency) {
        ...
        final float progress = 1.f -
                Math.abs(dependency.getTranslationY() / (dependency.getHeight() - resources.getDimension
    ...
    @Override
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, RecyclerView child, View target, int
    ...
    private boolean onUserStopDragging(float velocity) {
        ...
        boolean targetState = false; // Flag indicates whether to expand the content.
