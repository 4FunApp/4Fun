...
/**
 * demo address:https://github.com/githubwing/DragPhotoView
...
public class DragPhotoView extends PhotoView {
    ...
    public DragPhotoView(Context context, AttributeSet attr, int defStyle) {
        ...
        mPaint = new Paint();
        mPaint.setColor(Color.rgb(74, 74, 74));
    }
    ...
    private void onActionUp(MotionEvent event) {
        ...
        if (mTranslateY > MAX_TRANSLATE_Y) {
            if (mExitListener != null) {
                ...
                throw new RuntimeException("DragPhotoView: onExitLister can't be null ! call " +
                        "setOnExitListener() ");
            }
        } else {
            performAnimation();
